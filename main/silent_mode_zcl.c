...
esp_err_t silent_mode_zcl_sync(bool silent_mode_enabled) {
  ...
  ezb_err_t err = ezb_zcl_set_attr_value(
      EP_ID, EZB_ZCL_CLUSTER_ID_ON_OFF, EZB_ZCL_CLUSTER_SERVER,
      EZB_ZCL_ATTR_ON_OFF_ON_OFF_ID, EZB_ZCL_STD_MANUF_CODE, &zb_val, false);
  ...
  ezb_zcl_report_attr_cmd_t report = {
      .cmd_ctrl = {.cluster_id = EZB_ZCL_CLUSTER_ID_ON_OFF, .dst_ep = EP_ID},
      .payload = {.attr_id = EZB_ZCL_ATTR_ON_OFF_ON_OFF_ID}};
